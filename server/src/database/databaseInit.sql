...
(
 ...
 insert into users (name, password, email, avatar, role) values ('owner', 'owner123', 'owner@gmail.com', 'https://i.imgur.com/hZ4OaJI.jpg', 'owner');
 insert into users (name, password, email, avatar, role) values ('someGuy', 'someGuy123', 'someGuy@gmail.com', 'https://i.imgur.com/cTwkOjn.png', 'user');
